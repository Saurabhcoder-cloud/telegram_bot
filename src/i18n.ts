...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "filing.upload_hint_w2": "📤 Tip: Send a photo or PDF of your W-2 to auto-fill this section.",
    "filing.upload_hint_1099": "📤 You can upload your 1099 (INT/NEC) and I'll extract the amounts for you.",
    "filing.upload_hint_schedule_c": "📤 Upload 1099-NEC or business income documents to prefill Schedule C.",
    ...
    "filing.ocr_processing": "🔄 Processing your document. This usually takes a few seconds...",
    "filing.ocr_success": "✅ Document processed automatically.",
    "filing.ocr_success_header": "Captured values:",
    "filing.ocr_failed":
      "⚠️ I couldn't read that file. Please try again with a clearer image or enter the numbers manually.",
    "filing.ocr_not_supported": "I can't process that document for this step. Please enter the details manually.",
    "filing.ocr_no_fields": "No recognizable fields were extracted.",
    "filing.select_form": "Choose the form you want to work on.",
    "filing.upload_prompt": "Upload your {{form}} so I can auto-fill the details.",
    "filing.form_select_before_upload": "Please pick a form first so I know what to extract.",
    "filing.form_upload_not_expected":
      "I've already processed a document for this step. Answer the remaining questions or go back if you need to switch forms.",
    "filing.form_missing_list": "I still need: {{fields}}.",
    "filing.form_all_captured": "All required fields from this form are captured.",
    "filing.form_missing_prompt": "Please provide {{field}}.",
    "filing.form_complete": "{{form}} captured. Moving to the next step.",
    "filing.form_label_w2": "Form W-2",
    "filing.form_label_1099_int": "Form 1099-INT",
    "filing.form_label_1099_nec": "Form 1099-NEC",
    "filing.form_field_employer": "Employer",
    "filing.form_field_wages": "Wages",
    "filing.form_field_federal_tax_withheld": "Federal tax withheld",
    "filing.form_field_payer": "Payer",
    "filing.form_field_interest_income": "Interest income",
    "filing.form_field_non_employee_comp": "Non-employee compensation",
    ...
    "estimate.summary_child_credit": "Child Tax Credit: {{amount}}",
    "estimate.summary_eitc": "Earned Income Credit: {{amount}}",
    "estimate.summary_education_credit": "Education Credit: {{amount}}",
    "estimate.summary_marginal_rate": "Marginal tax rate: {{rate}}%",
    ...
    "pdf.unavailable": "I couldn't generate a PDF right now. You can try again from the documents menu.",
  ...
  es: {
    ...
    "filing.upload_hint_w2": "📤 Consejo: envía una foto o PDF de tu W-2 para completar automáticamente esta sección.",
    "filing.upload_hint_1099": "📤 Puedes subir tu 1099 (INT/NEC) y extraeré los montos por ti.",
    "filing.upload_hint_schedule_c": "📤 Sube tus 1099-NEC o documentos de negocio para prellenar el Schedule C.",
    ...
    "filing.ocr_processing": "🔄 Procesando tu documento. Esto suele tardar unos segundos...",
    "filing.ocr_success": "✅ Documento procesado automáticamente.",
    "filing.ocr_success_header": "Valores capturados:",
    "filing.ocr_failed":
      "⚠️ No pude leer ese archivo. Intenta con una imagen más clara o ingresa los datos manualmente.",
    "filing.ocr_not_supported": "No puedo procesar ese documento en este paso. Ingresa los datos manualmente.",
    "filing.ocr_no_fields": "No se detectaron campos reconocibles.",
    "filing.select_form": "Elige el formulario con el que deseas trabajar.",
    "filing.upload_prompt": "Sube tu {{form}} para que pueda completar los datos automáticamente.",
    "filing.form_select_before_upload": "Primero selecciona un formulario para saber qué información extraer.",
    "filing.form_upload_not_expected":
      "Ya procesé un documento en este paso. Responde las preguntas pendientes o vuelve atrás si necesitas cambiar de formulario.",
    "filing.form_missing_list": "Aún necesito: {{fields}}.",
    "filing.form_all_captured": "Todos los campos requeridos de este formulario están completos.",
    "filing.form_missing_prompt": "Por favor ingresa {{field}}.",
    "filing.form_complete": "{{form}} capturado. Pasemos al siguiente paso.",
    "filing.form_label_w2": "Formulario W-2",
    "filing.form_label_1099_int": "Formulario 1099-INT",
    "filing.form_label_1099_nec": "Formulario 1099-NEC",
    "filing.form_field_employer": "Empleador",
    "filing.form_field_wages": "Salarios",
    "filing.form_field_federal_tax_withheld": "Impuesto federal retenido",
    "filing.form_field_payer": "Pagador",
    "filing.form_field_interest_income": "Ingresos por intereses",
    "filing.form_field_non_employee_comp": "Compensación de contratista",
    ...
    "pdf.unavailable": "No pude generar el PDF en este momento. Intenta de nuevo desde el menú de documentos.",
  ...
  ru: {
    ...
    "filing.upload_hint_w2": "📤 Совет: отправьте фото или PDF формы W-2, чтобы заполнить раздел автоматически.",
    "filing.upload_hint_1099": "📤 Вы можете загрузить форму 1099 (INT/NEC), и я извлеку суммы за вас.",
    "filing.upload_hint_schedule_c": "📤 Загрузите 1099-NEC или документы по бизнес-доходу, чтобы заполнить Schedule C.",
    ...
    "filing.ocr_processing": "🔄 Обрабатываю ваш документ. Это займёт несколько секунд...",
    "filing.ocr_success": "✅ Документ обработан автоматически.",
    "filing.ocr_success_header": "Извлечённые данные:",
    "filing.ocr_failed":
      "⚠️ Не удалось распознать файл. Попробуйте более чёткое изображение или введите данные вручную.",
    "filing.ocr_not_supported": "Для этого шага документ не поддерживается. Введите данные вручную.",
    "filing.ocr_no_fields": "Распознанных полей не найдено.",
    "filing.select_form": "Выберите форму, с которой хотите работать.",
    "filing.upload_prompt": "Загрузите {{form}}, и я заполню данные автоматически.",
    "filing.form_select_before_upload": "Сначала выберите форму, чтобы я понимал, что извлекать.",
    "filing.form_upload_not_expected":
      "Для этого шага документ уже обработан. Ответьте на оставшиеся вопросы или вернитесь, чтобы сменить форму.",
    "filing.form_missing_list": "Нужно ещё: {{fields}}.",
    "filing.form_all_captured": "Все обязательные поля из этой формы заполнены.",
    "filing.form_missing_prompt": "Укажите {{field}}.",
    "filing.form_complete": "{{form}} заполнена. Переходим к следующему шагу.",
    "filing.form_label_w2": "Форма W-2",
    "filing.form_label_1099_int": "Форма 1099-INT",
    "filing.form_label_1099_nec": "Форма 1099-NEC",
    "filing.form_field_employer": "Работодатель",
    "filing.form_field_wages": "Зарплата",
    "filing.form_field_federal_tax_withheld": "Удержанный федеральный налог",
    "filing.form_field_payer": "Плательщик",
    "filing.form_field_interest_income": "Процентный доход",
    "filing.form_field_non_employee_comp": "Вознаграждение подрядчика",
    ...
    "pdf.unavailable": "Не удалось сформировать PDF. Попробуйте снова через меню документов.",
  ...
  zh: {
    ...
    "filing.upload_hint_w2": "📤 小贴士：发送 W-2 的照片或 PDF，我会自动填写本部分。",
    "filing.upload_hint_1099": "📤 你可以上传 1099（INT/NEC），我会帮你提取金额。",
    "filing.upload_hint_schedule_c": "📤 上传 1099-NEC 或业务收入文件以预填 Schedule C。",
    "filing.saved": "进度已保存。",
    ...
    "filing.ocr_processing": "🔄 正在处理你的文件，这通常只需几秒钟...",
    "filing.ocr_success": "✅ 已自动读取文件。",
    "filing.ocr_success_header": "提取的数值：",
    "filing.ocr_failed": "⚠️ 无法识别该文件，请尝试更清晰的图片或手动输入。",
    "filing.ocr_not_supported": "此步骤无法处理该文件，请手动输入信息。",
    "filing.ocr_no_fields": "未识别到可用字段。",
    "filing.select_form": "请选择要填写的表格。",
    "filing.upload_prompt": "请上传 {{form}}，我会自动填写相关信息。",
    "filing.form_select_before_upload": "请先选择表格，以便我知道需要提取哪些数据。",
    "filing.form_upload_not_expected": "此步骤的文件已处理。请回答剩余问题，或返回重新选择表格。",
    "filing.form_missing_list": "还需要：{{fields}}。",
    "filing.form_all_captured": "此表格的必填字段都已记录。",
    "filing.form_missing_prompt": "请输入{{field}}。",
    "filing.form_complete": "{{form}} 已记录，继续下一步。",
    "filing.form_label_w2": "W-2 表",
    "filing.form_label_1099_int": "1099-INT 表",
    "filing.form_label_1099_nec": "1099-NEC 表",
    "filing.form_field_employer": "雇主",
    "filing.form_field_wages": "工资",
    "filing.form_field_federal_tax_withheld": "预扣联邦税",
    "filing.form_field_payer": "付款方",
    "filing.form_field_interest_income": "利息收入",
    "filing.form_field_non_employee_comp": "非雇员报酬",
    ...
    "pdf.unavailable": "暂时无法生成 PDF，请稍后在文件菜单中再试。",
  ...
  ar: {
    ...
    "filing.upload_hint_w2": "📤 تلميح: أرسل صورة أو PDF لنموذج W-2 وسيتم تعبئة هذه الخانة تلقائياً.",
    "filing.upload_hint_1099": "📤 يمكنك رفع نموذج 1099 (INT/NEC) وسأستخرج المبالغ لك.",
    "filing.upload_hint_schedule_c": "📤 ارفع نماذج 1099-NEC أو مستندات دخل الأعمال لملء Schedule C مسبقاً.",
    ...
    "filing.ocr_processing": "🔄 جاري معالجة المستند وقد يستغرق ذلك بضع ثوانٍ...",
    "filing.ocr_success": "✅ تم قراءة المستند تلقائياً.",
    "filing.ocr_success_header": "القيم المستخرجة:",
    "filing.ocr_failed": "⚠️ تعذّر قراءة الملف. جرّب صورة أوضح أو أدخل البيانات يدوياً.",
    "filing.ocr_not_supported": "لا يمكن معالجة هذا المستند في هذه الخطوة. يرجى الإدخال اليدوي.",
    "filing.ocr_no_fields": "لم يتم التعرف على أي حقول.",
    "filing.select_form": "اختر النموذج الذي ترغب في العمل عليه.",
    "filing.upload_prompt": "قم برفع {{form}} لأقوم بملء البيانات تلقائياً.",
    "filing.form_select_before_upload": "يرجى اختيار نموذج أولاً لمعرفة البيانات المطلوب استخراجها.",
    "filing.form_upload_not_expected":
      "تمت معالجة مستند لهذا الخطوة بالفعل. أجب عن الأسئلة المتبقية أو ارجع لتغيير النموذج.",
    "filing.form_missing_list": "ما زلت أحتاج إلى: {{fields}}.",
    "filing.form_all_captured": "تم جمع كل الحقول المطلوبة من هذا النموذج.",
    "filing.form_missing_prompt": "يرجى تزويدي بـ {{field}}.",
    "filing.form_complete": "{{form}} تم تسجيله. ننتقل إلى الخطوة التالية.",
    "filing.form_label_w2": "نموذج W-2",
    "filing.form_label_1099_int": "نموذج 1099-INT",
    "filing.form_label_1099_nec": "نموذج 1099-NEC",
    "filing.form_field_employer": "صاحب العمل",
    "filing.form_field_wages": "الأجور",
    "filing.form_field_federal_tax_withheld": "الضريبة الفيدرالية المقتطعة",
    "filing.form_field_payer": "الجهة الدافعة",
    "filing.form_field_interest_income": "دخل الفوائد",
    "filing.form_field_non_employee_comp": "تعويض غير الموظفين",
    ...
    "pdf.unavailable": "تعذّر إنشاء ملف PDF الآن. حاول مرة أخرى من قائمة المستندات.",
  ...
  fa: {
    ...
    "filing.upload_hint_w2": "📤 نکته: عکس یا PDF فرم W-2 را ارسال کنید تا این بخش به‌صورت خودکار تکمیل شود.",
    "filing.upload_hint_1099": "📤 می‌توانید فرم 1099 (INT/NEC) را بارگذاری کنید و مبالغ را برایتان استخراج می‌کنم.",
    "filing.upload_hint_schedule_c": "📤 فرم‌های 1099-NEC یا مدارک درآمد کسب‌وکار را بارگذاری کنید تا Schedule C پیش‌نویس شود.",
    ...
    "filing.ocr_processing": "🔄 در حال پردازش سند هستم، این کار چند ثانیه طول می‌کشد...",
    "filing.ocr_success": "✅ سند به‌صورت خودکار خوانده شد.",
    "filing.ocr_success_header": "مقادیر استخراج‌شده:",
    "filing.ocr_failed": "⚠️ نتوانستم فایل را بخوانم. لطفاً تصویر واضح‌تری بفرستید یا دستی وارد کنید.",
    "filing.ocr_not_supported": "این مرحله از این نوع سند پشتیبانی نمی‌کند. لطفاً داده‌ها را دستی وارد کنید.",
    "filing.ocr_no_fields": "هیچ فیلدی شناسایی نشد.",
    "filing.select_form": "لطفاً فرم مورد نظر خود را انتخاب کنید.",
    "filing.upload_prompt": "{{form}} را بارگذاری کنید تا اطلاعات به‌طور خودکار تکمیل شود.",
    "filing.form_select_before_upload": "ابتدا فرم را انتخاب کنید تا بدانم چه داده‌ای را استخراج کنم.",
    "filing.form_upload_not_expected":
      "برای این مرحله قبلاً سندی پردازش شده است. پرسش‌های باقی‌مانده را پاسخ دهید یا برای تغییر فرم بازگردید.",
    "filing.form_missing_list": "هنوز به موارد زیر نیاز دارم: {{fields}}.",
    "filing.form_all_captured": "همه فیلدهای الزامی این فرم ثبت شد.",
    "filing.form_missing_prompt": "لطفاً {{field}} را وارد کنید.",
    "filing.form_complete": "{{form}} ثبت شد. به مرحله بعد می‌رویم.",
    "filing.form_label_w2": "فرم W-2",
    "filing.form_label_1099_int": "فرم 1099-INT",
    "filing.form_label_1099_nec": "فرم 1099-NEC",
    "filing.form_field_employer": "کارفرما",
    "filing.form_field_wages": "دستمزد",
    "filing.form_field_federal_tax_withheld": "مالیات فدرال کسرشده",
    "filing.form_field_payer": "پرداخت‌کننده",
    "filing.form_field_interest_income": "درآمد بهره",
    "filing.form_field_non_employee_comp": "دستمزد غیرکارمند",
    ...
    "pdf.unavailable": "فعلاً نمی‌توانم PDF بسازم. بعداً از منوی اسناد دوباره امتحان کنید.",

...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "registration.phone_saved": "Phone number saved ✅ Registration complete.",
  ...
  es: {
    ...
    "registration.phone_saved": "Número de teléfono guardado ✅ Registro completado.",
  ...
  ru: {
    ...
    "registration.phone_saved": "Номер телефона сохранён ✅ Регистрация завершена.",
  ...
  zh: {
    ...
    "registration.phone_saved": "电话号码已保存 ✅ 注册完成。",
  ...
  ar: {
    ...
    "registration.phone_saved": "تم حفظ رقم الهاتف ✅ اكتمل التسجيل.",
  ...
  fa: {
    ...
    "registration.phone_saved": "شماره تلفن ذخیره شد ✅ ثبت‌نام تکمیل شد.",

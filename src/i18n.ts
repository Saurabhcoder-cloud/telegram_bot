...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "auth.login_required": "Please sign in with your email and the default password (TempTax@44) to continue.",
    ...
    "registration.completed": "🎉 Registration completed! Sign in later with your email and password TempTax@44.",
    "registration.completed_offline":
      "🎉 Registration saved! I'll sync it once we're back online. When prompted, sign in with your email and password TempTax@44.",
    ...
    "login.ask_password": "Enter your password. Use the default TempTax@44 if you haven't changed it.",
  ...
  es: {
    ...
    "auth.login_required": "Inicia sesión con tu correo y la contraseña predeterminada (TempTax@44) para continuar.",
    ...
    "registration.completed": "🎉 Registro completado! Inicia sesión más tarde con tu correo y la contraseña TempTax@44.",
    "registration.completed_offline":
      "🎉 ¡Registro guardado! Lo sincronizaré cuando volvamos a estar en línea. Cuando se te pida, inicia sesión con tu correo y la contraseña TempTax@44.",
    ...
    "login.ask_password": "Ingresa tu contraseña. Usa la predeterminada TempTax@44 si no la has cambiado.",
  ...
  ru: {
    ...
    "auth.login_required": "Пожалуйста, войдите, используя email и стандартный пароль (TempTax@44), чтобы продолжить.",
    ...
    "registration.completed": "🎉 Регистрация завершена! Войдите позже, используя email и пароль TempTax@44.",
    "registration.completed_offline":
      "🎉 Регистрация сохранена! Я синхронизирую данные, как только появится подключение. При входе используйте email и пароль TempTax@44.",
    ...
    "login.ask_password": "Введите пароль. Используйте стандартный TempTax@44, если вы его не меняли.",
  ...
  zh: {
    ...
    "auth.login_required": "请使用您的邮箱和默认密码（TempTax@44）登录以继续。",
    ...
    "registration.completed": "🎉 注册成功！稍后使用邮箱和密码 TempTax@44 登录。",
    "registration.completed_offline":
      "🎉 注册信息已保存！联网后我会自动同步。提示：登录时请使用邮箱和密码 TempTax@44。",
    "registration.duplicate": "您似乎已经有账号，我们来登录吧。",
    "registration.success_returning": "欢迎回来，{{name}}！",
    "login.ask_email": "请输入与账号关联的邮箱。",
    "login.ask_password": "请输入密码。如未修改，请使用默认密码 TempTax@44。",
  ...
  ar: {
    ...
    "auth.login_required": "يرجى تسجيل الدخول باستخدام بريدك الإلكتروني وكلمة المرور الافتراضية (TempTax@44) للمتابعة.",
    ...
    "registration.completed": "🎉 تم التسجيل بنجاح! سجّل الدخول لاحقًا باستخدام بريدك الإلكتروني وكلمة المرور TempTax@44.",
    "registration.completed_offline":
      "🎉 تم حفظ التسجيل! سأتم المزامنة عند عودة الاتصال. عند الطلب، استخدم بريدك الإلكتروني وكلمة المرور TempTax@44.",
    ...
    "login.ask_password": "أدخل كلمة المرور. استخدم الكلمة الافتراضية TempTax@44 إذا لم تغيّرها.",
  ...
  fa: {
    ...
    "auth.login_required": "لطفاً با ایمیل و گذرواژه پیش‌فرض (TempTax@44) وارد شوید تا ادامه دهیم.",
    ...
    "registration.completed": "🎉 ثبت‌نام با موفقیت انجام شد! بعداً با ایمیل و گذرواژه TempTax@44 وارد شوید.",
    "registration.completed_offline":
      "🎉 ثبت‌نام ذخیره شد! به محض اتصال دوباره همگام‌سازی می‌کنم. هنگام ورود از ایمیل و گذرواژه TempTax@44 استفاده کنید.",
    ...
    "login.ask_password": "گذرواژه را وارد کنید. اگر تغییرش نداده‌اید از گذرواژه پیش‌فرض TempTax@44 استفاده کنید.",

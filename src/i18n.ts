...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "registration.ask_phone": "What is your mobile number? We'll send a verification code via SMS.",
    "registration.ask_otp": "Enter the 6-digit code we sent to {{phone}}.",
    ...
    "registration.invalid_phone": "Please enter a valid phone number including your country or area code.",
    ...
    "registration.otp_sent": "We sent a verification code to {{phone}}.",
    "registration.resend_otp": "🔁 Resend code",
    "registration.change_phone": "Edit phone number",
    "registration.change_phone_prompt": "Okay, let's update your phone number.",
    "registration.phone_required": "We need your verified phone number to continue. Please enter it again.",
    "registration.otp_resend_timer": "You can request a new code in {{seconds}} seconds.",
    "registration.otp_resend_wait": "Please wait {{seconds}} seconds before requesting another code.",
    "registration.otp_resend_sent": "A new verification code was sent to {{phone}}.",
    "registration.otp_invalid": "That code didn't match. Please try again.",
    "registration.otp_verify_failed": "We couldn't verify that code. Please try again shortly.",
    "registration.otp_required": "Please verify your phone number to continue.",
    "registration.otp_send_failed": "We couldn't send the verification code. Please try again.",
    "registration.otp_verified": "✅ Phone number verified!",
    ...
    "profile.invalid_state": "Please enter a two-letter state or territory code.",
  ...
  es: {
    ...
    "registration.ask_phone": "¿Cuál es tu número de teléfono móvil? Te enviaremos un código de verificación por SMS.",
    "registration.ask_otp": "Ingresa el código de 6 dígitos que enviamos a {{phone}}.",
    ...
    "registration.invalid_phone": "Ingresa un número de teléfono válido con tu código de país o área.",
    ...
    "registration.otp_sent": "Enviamos un código de verificación a {{phone}}.",
    "registration.resend_otp": "🔁 Reenviar código",
    "registration.change_phone": "Editar número",
    "registration.change_phone_prompt": "De acuerdo, actualicemos tu número de teléfono.",
    "registration.phone_required": "Necesitamos tu número verificado para continuar. Por favor, escríbelo nuevamente.",
    "registration.otp_resend_timer": "Podrás pedir un nuevo código en {{seconds}} segundos.",
    "registration.otp_resend_wait": "Espera {{seconds}} segundos antes de solicitar otro código.",
    "registration.otp_resend_sent": "Se envió un nuevo código de verificación a {{phone}}.",
    "registration.otp_invalid": "Ese código no coincide. Intenta otra vez.",
    "registration.otp_verify_failed": "No pudimos verificar ese código. Inténtalo nuevamente en unos instantes.",
    "registration.otp_required": "Verifica tu número de teléfono para continuar.",
    "registration.otp_send_failed": "No pudimos enviar el código de verificación. Inténtalo de nuevo.",
    "registration.otp_verified": "✅ ¡Número verificado!",
    ...
    "profile.invalid_state": "Proporciona el código de estado de dos letras.",
  ...
  ru: {
    ...
    "registration.ask_phone": "Укажите номер мобильного телефона. Мы отправим SMS с кодом подтверждения.",
    "registration.ask_otp": "Введите 6-значный код, который мы отправили на {{phone}}.",
    ...
    "registration.invalid_phone": "Пожалуйста, введите корректный номер телефона с кодом страны или региона.",
    ...
    "registration.otp_sent": "Мы отправили код подтверждения на {{phone}}.",
    "registration.resend_otp": "🔁 Отправить код ещё раз",
    "registration.change_phone": "Изменить номер",
    "registration.change_phone_prompt": "Хорошо, обновим ваш номер телефона.",
    "registration.phone_required": "Нам нужен подтверждённый номер телефона. Введите его ещё раз.",
    "registration.otp_resend_timer": "Повторно запросить код можно через {{seconds}} сек.",
    "registration.otp_resend_wait": "Пожалуйста, подождите {{seconds}} сек. перед повторным запросом.",
    "registration.otp_resend_sent": "Новый код подтверждения отправлен на {{phone}}.",
    "registration.otp_invalid": "Код не подошёл. Попробуйте ещё раз.",
    "registration.otp_verify_failed": "Не удалось проверить код. Попробуйте позже.",
    "registration.otp_required": "Подтвердите номер телефона, чтобы продолжить.",
    "registration.otp_send_failed": "Не удалось отправить код подтверждения. Попробуйте снова.",
    "registration.otp_verified": "✅ Номер телефона подтверждён!",
    ...
    "profile.invalid_state": "Введите двухбуквенный код штата или региона.",
  ...
  zh: {
    ...
    "registration.ask_phone": "请输入您的手机号，我们会通过短信发送验证码。",
    "registration.ask_otp": "请输入发送到 {{phone}} 的6位验证码。",
    ...
    "registration.invalid_phone": "请填写包含国家或地区区号的有效电话号码。",
    "registration.invalid_email": "邮箱格式看起来不正确，请重试。",
    "registration.invalid_dob": "请使用 YYYY-MM-DD 格式。",
    "registration.otp_sent": "验证码已发送至 {{phone}}。",
    "registration.resend_otp": "🔁 重新发送验证码",
    "registration.change_phone": "修改手机号",
    "registration.change_phone_prompt": "好的，我们来更新您的手机号。",
    "registration.phone_required": "需要验证过的手机号才能继续，请重新输入。",
    "registration.otp_resend_timer": "{{seconds}} 秒后可以重新获取验证码。",
    "registration.otp_resend_wait": "请等待 {{seconds}} 秒后再试一次。",
    "registration.otp_resend_sent": "新的验证码已发送至 {{phone}}。",
    "registration.otp_invalid": "验证码不正确，请重试。",
    "registration.otp_verify_failed": "验证码校验失败，请稍后再试。",
    "registration.otp_required": "请先验证您的手机号再继续。",
    "registration.otp_send_failed": "验证码发送失败，请重试。",
    "registration.otp_verified": "✅ 手机号验证成功！",
    ...
    "profile.invalid_state": "请输入两位字母的州或地区代码。",
  ...
  ar: {
    ...
    "registration.ask_phone": "ما هو رقم هاتفك المحمول؟ سنرسل رمز تحقق عبر رسالة نصية.",
    "registration.ask_otp": "أدخل الرمز المكوَّن من 6 أرقام المرسل إلى {{phone}}.",
    ...
    "registration.invalid_phone": "يرجى إدخال رقم هاتف صحيح مع رمز الدولة أو المنطقة.",
    ...
    "registration.otp_sent": "تم إرسال رمز التحقق إلى {{phone}}.",
    "registration.resend_otp": "🔁 إعادة إرسال الرمز",
    "registration.change_phone": "تعديل رقم الهاتف",
    "registration.change_phone_prompt": "حسنًا، لنحدّث رقم هاتفك.",
    "registration.phone_required": "نحتاج إلى رقم هاتفك الموثّق للمتابعة. يرجى إدخاله مرة أخرى.",
    "registration.otp_resend_timer": "يمكنك طلب رمز جديد بعد {{seconds}} ثانية.",
    "registration.otp_resend_wait": "يرجى الانتظار {{seconds}} ثانية قبل طلب رمز آخر.",
    "registration.otp_resend_sent": "تم إرسال رمز تحقق جديد إلى {{phone}}.",
    "registration.otp_invalid": "الرمز غير صحيح. حاول مرة أخرى.",
    "registration.otp_verify_failed": "تعذر التحقق من الرمز. حاول مجددًا بعد قليل.",
    "registration.otp_required": "يرجى توثيق رقم هاتفك للمتابعة.",
    "registration.otp_send_failed": "تعذر إرسال رمز التحقق. حاول مرة أخرى.",
    "registration.otp_verified": "✅ تم توثيق رقم الهاتف!",
    ...
    "profile.invalid_state": "يرجى إدخال رمز الولاية المكوّن من حرفين.",
  ...
  fa: {
    ...
    "registration.ask_phone": "شماره موبایل خود را وارد کنید تا کد تأیید را از طریق پیامک ارسال کنیم.",
    "registration.ask_otp": "کد ۶ رقمی ارسال‌شده به {{phone}} را وارد کنید.",
    ...
    "registration.invalid_phone": "لطفاً یک شماره تلفن معتبر همراه با کد کشور یا منطقه وارد کنید.",
    ...
    "registration.otp_sent": "کد تأیید به {{phone}} ارسال شد.",
    "registration.resend_otp": "🔁 ارسال دوباره کد",
    "registration.change_phone": "ویرایش شماره تلفن",
    "registration.change_phone_prompt": "باشه، شماره تلفنت رو به‌روزرسانی کنیم.",
    "registration.phone_required": "برای ادامه به شماره تلفن تأییدشده نیاز داریم. لطفاً دوباره واردش کن.",
    "registration.otp_resend_timer": "می‌توانی پس از {{seconds}} ثانیه دوباره درخواست کد بدهی.",
    "registration.otp_resend_wait": "لطفاً {{seconds}} ثانیه صبر کن و بعد دوباره درخواست بده.",
    "registration.otp_resend_sent": "کد تأیید جدید به {{phone}} ارسال شد.",
    "registration.otp_invalid": "این کد درست نبود. لطفاً دوباره امتحان کن.",
    "registration.otp_verify_failed": "نتوانستیم کد را تأیید کنیم. چند لحظه بعد دوباره تلاش کن.",
    "registration.otp_required": "برای ادامه باید شماره تلفنت را تأیید کنی.",
    "registration.otp_send_failed": "ارسال کد تأیید انجام نشد. دوباره تلاش کن.",
    "registration.otp_verified": "✅ شماره تلفن تأیید شد!",
    ...
    "profile.invalid_state": "لطفاً کد دو حرفی ایالت/استان را وارد کنید.",
